...
DRIVE_DIR = '/content/drive/MyDrive/MSE641_Task2_BART'
import os
...
args = Seq2SeqTrainingArguments(
    output_dir='/content/task2-bart-output',
    num_train_epochs=10,
...
with open(f'{DRIVE_DIR}/task2-bart-val-preds.jsonl', 'w') as f:
    for item, pred in zip(val_data, decoded):
        f.write(json.dumps({'uuid': item['id'], 'spoiler': pred}) + '\n')
print(f'Val predictions saved to {DRIVE_DIR}/task2-bart-val-preds.jsonl')
